...
<div class="centerContainers">
	<div class="footerCenterContainer">
		...
		<div class="inline floatLeft"> 
			...
			<div class="footerLinkItem">
				<div class="inline floatLeft footerEmailIcon"></div><div class="inline floatLeft"><a class="footerLinkText" href="mailto:${frameContent['siteFrame.emailContactUs']}">${frameContent['siteFrame.emailContactUs']}</a></div>
				<div class="clear"></div>
			</div>
		</div>
	</div>
