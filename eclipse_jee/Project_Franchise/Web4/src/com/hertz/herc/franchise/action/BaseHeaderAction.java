...
public class BaseHeaderAction extends BaseAction {
	...
	@Actions({
	    ...
	    @Action(value="equipment-rental-franchise-opportunities", results={@Result(name="success", location="home.home", type="tiles")})
	  })
//	@Action(value="home", results={@Result(name="success", location="home.home", type="tiles")})
	...
	@Action (value="contact-us-confirmation", results = {@Result (name="success", location = "home.contactUsConfirm", type = "tiles")})
	...
	public void task (int selected) {
		...
		switch (selected) {
			case 8:
				omnitureTagName = "franchise dialects";
				imageName = "equipment-rental-franchise-opportunities.jpg";
				altText = "Hertz Equipment Franchise Dialects";
				break;
			case 7:
		...
		nav.add (new NavItem ("Franchise Opportunity", "equipment-rental-franchise-opportunities", selected == 1, true));
